...
EOT;
		...
		foreach($pizzen as $pizza)
		{
			...
			echo "<div class='gericht'>{$pizza["PizzaNummer"]} {$pizza["PizzaName"]}</div>";
			echo "<img alt='{$pizza["PizzaName"]}' width='250' height='150' src='{$pizza["Bilddatei"]}'>";
			echo "<button class='gericht-button'>{$pizza["Preis"]} €</button>";
		}
		echo "</section>";
