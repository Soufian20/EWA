...
EOT;
        if ($headline == 'Fahrerr') {
            echo '<meta http-equiv="refresh" content="5; url=template_fahrer.php" />';
        }

        if ($headline == 'Pizzabäckerr') {
            echo '<meta http-equiv="refresh" content="5; url=template_pizzabaecker.php" />';
        }
